// ─── ZOUK TRAINER — ROOT COMPONENT ───────────────────
// Owns all React state/refs, the control handlers, and the UI.
// The 3D scene + animation loop live in ZT.createScene
// (src/app/sceneController.js); the modals live in ZT.Overlays
// (src/ui/overlays.jsx).
const { useEffect, useRef, useState } = React;

function ZoukTrainer() {
      ...
      <div className="zt-header" style={{
        ...
        <div className="zt-header-title" style={{ display: 'flex', alignItems: 'center', flexShrink: 0, flex: isMobile ? 1 : 'none', position: 'relative', justifyContent: 'center' }}>
          ...
          {isMobile && <div style={{ position: 'absolute', right: 0, display: 'flex', gap: 4, alignItems: 'center' }}>
            ...
            <button className="zt-btn-manual" title="User Manual"
              onClick={() => { gaEvent('manual_opened', { platform: 'mobile' }); window.location.href = '/manual.html'; }}
              style={{ width: 24, height: 24, borderRadius: '50%', background: '#3a3028', border: '1px solid #6a5438', color: '#cc9944', fontSize: 12, fontWeight: 700, cursor: 'pointer', lineHeight: '24px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 0 }}>?</button>
            <button
        ...
        {!isMobile && <>
          ...
          <button
            ...
            style={{ width: 24, height: 24, borderRadius: '50%', background: '#3a3028', border: '1px solid #6a5438', color: '#cc9944', fontSize: 11, fontWeight: 700, cursor: 'pointer', lineHeight: '24px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg></button>
          <button className="zt-btn-manual" title="User Manual"
            onClick={() => { gaEvent('manual_opened', { platform: 'desktop' }); window.location.href = '/manual.html'; }}
            style={{ width: 24, height: 24, borderRadius: '50%', background: '#3a3028', border: '1px solid #6a5438', color: '#cc9944', fontSize: 12, fontWeight: 700, cursor: 'pointer', lineHeight: '24px', flexShrink: 0, marginLeft: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 0 }}>?</button>
          <button
            className="zt-btn-about"
            title="About"
...
ReactDOM.createRoot(document.getElementById('root')).render(<ZoukTrainer />);
